...
const changeCurrentPassword = asyncHandler(async(req,res)=> {
    ...
    return res.status(200).json(new ApiResponse(200,{},"Invalid Old Password"));
})


const getCurrentUser = asyncHandler(async(req,res)=>{
    return res.status(200).json(200,new ApiResponse(200 , req.user,"Current User Fetched Successfully" ) )
})
...
const updaateUsercoverImage = asyncHandler(async(req,res)=>{
...
export {registerUser,loginUser , logoutUser , refreshAccessToken , changeCurrentPassword , getCurrentUser , updateAccountDetails , updaateUserAvatar , updaateUsercoverImage};
